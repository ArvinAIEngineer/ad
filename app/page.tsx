  ...
  return (
    <div className="max-w-3xl mx-auto my-10 px-4">
      ...
      <section className="grid grid-cols-2 gap-4 mt-4">
        ...
        <div className="relative">
          <h1 className="font-semibold text-transparent text-2xl bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block bg-clip-text">
            Option 1 </h1>
          <img
            src="/images/background1.jpg" // Replace with the correct path to your background image
            alt="BigCo Inc. logo"
          ...
          {outputImage && (
            <img
              ...
              alt="output"
              className="object-cover w-full h-full"
              style={{ position: "absolute", top: 175, left: 75, zIndex: 2, width:180, height:180, alignItems:"center",justifyContent:"center", cursor:"pointer" }}
            ...
            Option 2 </h1>
          <img
            src="/images/background2.jpg" // Replace with the correct path to your background image
            alt="BigCo Inc. logo"
          ...
          {outputImage && (
            <img
              ...
              alt="output"
              className="object-cover w-full h-full"
              style={{ position: "absolute", top: 165, left: 75, zIndex: 2, width:180, height:180, alignItems:"center",justifyContent:"center", cursor:"pointer" }}
              onClick={handleImageClick}
            />
          ...
          <img
            src="/images/background3.jpg" // Replace with the correct path to your background image
            alt="BigCo Inc. logo"
          ...
          {outputImage && (
            <img
              ...
              alt="output"
              className="object-cover w-full h-full"
              style={{ position: "absolute", top: 175, left: 35, zIndex: 2, width:180, height:180, alignItems:"center",justifyContent:"center", cursor:"pointer" }}
              onClick={handleImageClick}
            />
        ...
        <h1 className="font-semibold text-transparent text-2xl bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block bg-clip-text">
            Option 4 </h1>
          <img
            src="/images/background4.jpg" // Replace with the correct path to your background image
            alt="BigCo Inc. logo"
          ...
          {outputImage && (
            <img
              ...
              alt="output"
              className="object-cover w-full h-full"
              style={{ position: "absolute", top: 160, left: 75, zIndex: 2, width:180, height:180, alignItems:"center",justifyContent:"center", cursor:"pointer" }}
              onClick={handleImageClick}
            />
